...
def generate_solve_map(tech, grid_width=3, grid_height=2):
    """Generates a single solve map for a given technology."""
    grid = Grid(width=grid_width, height=grid_height)
    try:
        optimized_grid, _ = refine_placement(grid, "Exotic", modules, tech)  #Using Exotic ship
...
if __name__ == "__main__":
    ...
    solve_map = generate_solve_map(tech)
